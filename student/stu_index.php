...
$sqlstr="select * from notice Order by Notice_time DESC limit 10 offset 0";
    ...
    $new_notice="<a href='stu_notice_content.php?id=".$row[0]."'>".$row[2]."</a>";
    ...
    <div class="left">
      <div class="box_1">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td colspan="2">
              <input name="input" type="image" src="../images/img_61.gif" onclick="javascript:window.location.href='xinxi.php?id=<?=$User_ID?>'"/>
...
<script> 
    ...
    <div class="right">
      ...
      <div class="news">
        <div class="news_title"><span><img src="../images/title_11.gif" /></span><a href="stu_notice.php"><img src="../images/more.gif" /></a></div>
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <?=$notice?>
