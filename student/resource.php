...
$sqlstr="select * from resource where Resource_type='私有资源' and Resource_name='".$User_teacher."' Order by Resource_time ASC";
	$result = mysql_query($sqlstr,$link);
...
$sqlstr="select * from resource where Resource_type='公共资源' Order by Resource_time ASC";
	$result = mysql_query($sqlstr,$link);
...
$sqlstr="select * from model_detial,chapter where model_detial.Stu_weakpoint=chapter.Chapter_no and model_detial.Stu_no=".$User_no;
$result = mysql_query($sqlstr,$link);
$row=mysql_fetch_row($result);
$weakpoint=$row[9];

$sqlstr="select * from resource where Resource_chapter='".$weakpoint."' Order by Resource_time ASC";
	$result = mysql_query($sqlstr,$link);
...
<script> 
    ...
    <div class="right">
     ...
     <div class="news">
      ...
      <div class="news_title"><img src="../images/title_21.gif"/></div>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
  ...
  <div class="bottom">北京理工大软件学院学<br/>
    版权所有<a></a></div>
