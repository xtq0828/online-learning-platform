...
<div style="font-size:18px" class="news">公告题目：<a name="Notice_title" id="Notice_title" rows="1" cols="80"><?=$notice_title?></a></div>
<div style="font-size:18px" class="news">公告内容：<a name="Notice_content" id="Notice_content" rows="10" cols="80"><?=$notice_content?></a></div>
<input style="float:left" name="input" type="image" src="../images/img_66.gif" onclick="javascript:window.location.href='stu_notice.php'">
</div>
