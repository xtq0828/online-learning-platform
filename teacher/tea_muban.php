...
function  add(){   
       ...
       window.location.href="tea_muban1.php?xuhao=<?php echo $str[0]?>"; //你需要跳转的地址  

    }  
function  shanchu(){   

       window.location.href="tea_shanchu.php?xuhao=<?php echo $str[0]?>"; //你需要跳转的地址  
...
$phpself =$_SERVER['PHP_SELF'];
 ...
 $str=explode('.php',$str);
  ...
  AMprocessNode(outnode);
       ...
       <input name="submit" type="button"  value="修改" onclick="javascript:add()"/>
       <input name="submit1" type="button"  value="删除" onclick="javascript:shanchu()"/>
