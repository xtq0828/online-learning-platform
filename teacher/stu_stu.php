...
<script> 
    ...
    <div class="right">
      <form action="stu_chg.php?id=<?=$stu_ID?>" method="post"><img src="../images/img_8.gif" style="float:left"/>
<div class="news">学生姓名：
  ...
  <textarea name="Stu_password" id="Stu_password" rows="1" cols="80" ><?=$stu_password?></textarea></div>
    ...
    <input  name="input" type="image" src="../images/img_688.gif" onclick="javascript:window.location.href='dropstu.php?id=<?=$stu_no?>'">
