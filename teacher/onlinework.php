...
<div class="zhong">
  ...
  <div class="main">
    ...
    <div class="right">
     ...
     <div class="news_title" ><span style="font-size:15px; font-weight:bold;"  style="display:block; width:400px;">"<?php echo $IsBeginArray['papers_title']; ?>"题目列表</span>
     <a style="font-weight:blod; color:red;"  href="newwork.php?papersid=<?php echo $_GET['papersid']; ?>">继续出题>></a></div>
	      ...
	      <?php
	       ...
	       $i=1; foreach($shitiArray as $value){  
	      		...
	      		<tr ><td colspan="2" style="font-weight:bold" ><?php  echo $i,"、","(单选)",$value['content']; ?></td>
	      				<td  style="font-weight:bold">分值：<?php echo $value['score']; ?>&nbsp;&nbsp;&nbsp;&nbsp;答案：<?php echo $value['answer']; ?></td>
