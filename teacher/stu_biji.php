...
$sqlstr="select * from note where User_no=".$_GET["sno"]." Order by xuhao ASC";
	$result = mysql_query($sqlstr,$link);
	...
	while($row=mysql_fetch_row($result))
	{
		$stu_xinxi=$stu_xinxi."
	<tr>
  		<td width=\"20%\" height=\"18\"><a href='stu_bijicontent.php?sno=".$row[1]."&xuhao=".$row[3]."'>".$row[1]."</a></td>
...
var reg = /\.txt$/;      
    ...
    if(t != ''){
		...
		d.add((m[0]-1)*20+1+m[2],(m[0]-1)*20+1,str,'../'+'$file[0]'+'.php');
		</script>";
}
}
closedir($handle); 
...
<div class="right">
      ...
      <div class="news">
        ...
        <div class="right">&nbsp;&nbsp;&nbsp;&nbsp; 学生学号&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 学生姓名&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 课程章节&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; 学习时间&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; 修改笔记次数</div>
