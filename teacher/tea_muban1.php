...
<script> 
    ...
    <div class="right">
        ...
        <div class="right">
     <form class="right" action="kecheng2.php" method="post"> 

    <input type="text" name="xuhao" id="xuhao" value="<?php echo $_GET["xuhao"]?>" style="display:none"/>  
...
<div class="right">请在公式的起始和结束部位加上"`"符号，如`p and q`</div>
     <textarea id="inputText" name="inputText" rows="12" cols="83" onkeyup="display()"><?php 
  $dir="../keben/wendang"; //这里输入其它路径
//PHP遍历文件夹下所有文件
$handle=opendir($dir."."); 
while (false !== ($file = readdir($handle)))
...
<div class="top_left" id="outputNode"> </div>
 </div>
<div class="right">
